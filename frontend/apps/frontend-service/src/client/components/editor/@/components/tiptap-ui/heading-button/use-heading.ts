...
import {
  ...
  isNodeTypeSelected,
  isValidPosition,
} from "@editor/lib/tiptap-utils"

// --- Icons ---
import { HeadingOneIcon } from "@editor/components/tiptap-icons/heading-one-icon"
import { HeadingTwoIcon } from "@editor/components/tiptap-icons/heading-two-icon"
import { HeadingThreeIcon } from "@editor/components/tiptap-icons/heading-three-icon"
import { HeadingFourIcon } from "@editor/components/tiptap-icons/heading-four-icon"
import { HeadingFiveIcon } from "@editor/components/tiptap-icons/heading-five-icon"
import { HeadingSixIcon } from "@editor/components/tiptap-icons/heading-six-icon"
